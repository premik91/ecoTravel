...
var defaults = {
    ...
    textFont: 'Helvetica',
    textSubSize: TEXTSIZE + 'dp',  // Font size of the label for the button.
    textSubFont: 'Helvetica',
    textColor: 'white',         // Text color of the label.
    textSubColor: 'white',         // Text color of the label.    
...
//        Ti.API.TFinfo('Buttongrid: creating button ' + button.id);
        ...
        if (OS_ANDROID || OS_MOBILEWEB) {
            if (button.title) {
                ...
                buttonProps.font = { fontSize: $._params.textSize, fontFamily: $._params.textFont };
        ...
        if (OS_IOS && button.title) {
            ...
            var theLabel = Ti.UI.createLabel({
                ...
                top: 3,
                font: { fontSize: $._params.textSize, fontFamily: $._params.textFont },
                text: button.title,
                textAlign: 'center',
                touchEnabled: false
            });
            ...
            btn.title = ''; // Override the default title, which doesn't work well with the icon.
        }
        if (OS_IOS && button.subtitle) {
            // On iOS we need to place the text label into the button view proper.
            var theSubLabel = Ti.UI.createLabel({
                ...
                height: Ti.UI.SIZE,
                bottom: 3,
                font: { fontSize: $._params.textSubSize, fontFamily: $._params.textSubFont },
