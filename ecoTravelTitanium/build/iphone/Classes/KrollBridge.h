...
@interface ecotravelObject : KrollCoverageObject {
#else
@interface ecotravelObject : KrollObject {
#endif
@private
...
extern NSString * ecotravel$ModuleRequireFormat;
