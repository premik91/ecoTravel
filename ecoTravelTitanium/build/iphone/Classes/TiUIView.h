...
/**
 Base class for all ecotravel views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ecotravel view hierarchy (such as wrapped iOS UIViews) was touched.
