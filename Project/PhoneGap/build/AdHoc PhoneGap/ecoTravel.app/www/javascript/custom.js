...
// Debug data
window.localStorage['user'] = '{"name":"Rok Kralj","total":4513.068200305322,"saved":311.0021136042848,"km":50.2507324365584,"modes":{"bike":{"km":15.453,"total":1730.736,"saved":-247.248,"number":1},"car":{"km":20.3,"total":2496.9,"saved":-548.1,"number":3},"bicycle":{"km":12.7,"total":152.4,"saved":1066.8,"number":1},"train":{"km":1.7977324365584,"total":133.032200305322,"saved":39.5501136042848,"number":1}}}';
window.localStorage['friends'] = '[["Rok Kralj",311.0021136042848,{"bike":15.453,"car":20.3,"bicycle":12.7,"train":1.7977324365584}],["Jon Premik",1265.0021136042848,{"car":45.3,"bicycle":698.456,"train":51.7977324365584}],["Roman Avsec",-2045.0021136042848,{"bike":15.453,"car":21345.3,"bicycle":12.7,"train":12.7977324365584}]]';
...
function onDeviceReady () {
    FB.init({ appId: '551670011523207', nativeInterface: CDV.FB, useCachedDialogs: false });    // Initialize the Facebook SDK
...
$( document ).delegate("#journey-page", "pageshow", function () {
    ...
    function Stopwatch () {
        if (window.localStorage['time']) {
            // In IOS restore time if sent to background
    ...
    function geoLocationSuccess (position) {
        ...
        if (number_positions < 3) {
            ...
            last_position_latitude = position.coords.latitude;
            last_position_longitude = position.coords.longitude;
            // Send data every send_when_distance kilometers
